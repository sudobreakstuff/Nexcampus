...
// ====== 11. SOLAR SYSTEM (interactive canvas) ======
TOOL_INIT.solar = function() {
  initSolarSystem();
};
...
var SOLAR_PLANETS = [
  ...
  { name:'Venus',   color:'#e8cda0', orbit:78, size:8.5, speed:1.62, angle:1.5,
    type:'Terrestrial',
    info:{diameter:'12,104 km', distSun:'108.2M km', year:'225 days', day:'243 days', moons:'0', type:'Terrestrial', gravity:'8.87 m/s²', temp:'462°C (avg)', atmosphere:'96% CO₂, 3.5% N₂', rings:'No', volume:'0.857 Earths', mass:'0.815 Earths', density:'5.24 g/cm³', inclination:'3.39°', axialTilt:'177.4° (retrograde)', discovered:'Known since antiquity', discoverer:'N/A', composition:'Rocky with metallic core', surface:'Volcanic plains, mountains, coronae', escapeVel:'10.36 km/s', albedo:'0.76', magneticField:'No', notable:'Surface pressure is 92× Earth. Clouds rain sulfuric acid.', missions:'Venera series (USSR), Magellan (1990), Venus Express (2006)', fact:'Venus spins backwards — a day is longer than its year! It\'s the hottest planet despite being farther from the Sun than Mercury.'} },
  { name:'Earth',   color:'#4fc3f7', orbit:105, size:9.5, speed:1.0,  angle:3.0,
    type:'Terrestrial',
    info:{diameter:'12,756 km', distSun:'149.6M km', year:'365.25 days', day:'24 hours', moons:'1', type:'Terrestrial', gravity:'9.81 m/s²', temp:'-89 to 57°C', atmosphere:'78% N₂, 21% O₂', rings:'No', volume:'1 (reference)', mass:'1 (reference)', density:'5.51 g/cm³', inclination:'0° (reference)', axialTilt:'23.4°', discovered:'N/A (home planet)', discoverer:'N/A', composition:'32% iron, 30% oxygen, 15% silicon', surface:'71% water, continents, mountains', escapeVel:'11.19 km/s', albedo:'0.367', magneticField:'Yes (dipole)', notable:'Only known planet with liquid water and life. The Moon stabilizes our axial tilt.', missions:'Thousands of satellites, ISS, Artemis (2025-)', fact:'Earth is the only known planet with liquid water and life! About 71% of Earth\'s surface is covered in water.'} },
  { name:'Mars',    color:'#e57373', orbit:132, size:7.5, speed:0.53, angle:4.5,
    type:'Terrestrial',
    info:{diameter:'6,792 km', distSun:'227.9M km', year:'687 days', day:'24.6 hours', moons:'2', type:'Terrestrial', gravity:'3.72 m/s²', temp:'-140 to 20°C', atmosphere:'95% CO₂, 2.7% N₂', rings:'No', volume:'0.151 Earths', mass:'0.107 Earths', density:'3.93 g/cm³', inclination:'1.85°', axialTilt:'25.2°', discovered:'Known since antiquity', discoverer:'N/A', composition:'Iron-rich crust, silicate mantle', surface:'Red desert, polar ice caps, canyons', escapeVel:'5.03 km/s', albedo:'0.15', magneticField:'No global field', notable:'Olympus Mons (21.9 km) is the tallest volcano. Valles Marineris is 4,000 km long.', missions:'Perseverance (2021), Ingenuity helicopter, Curiosity, Tianwen-1', fact:'Mars has the tallest mountain — Olympus Mons at 21.9 km is 2.5× the height of Everest! It also has the longest canyon, Valles Marineris.'} },
  { name:'Jupiter', color:'#d4a574', orbit:175, size:16, speed:0.084, angle:1.0,
    type:'Gas Giant',
    info:{diameter:'142,984 km', distSun:'778.5M km', year:'11.86 years', day:'9.9 hours', moons:'96 known', type:'Gas Giant', gravity:'24.79 m/s²', temp:'-110°C (cloud tops)', atmosphere:'89% H₂, 10% He', rings:'Faint ring system', volume:'1,321 Earths', mass:'318 Earths', density:'1.33 g/cm³', inclination:'1.3°', axialTilt:'3.1°', discovered:'Known since antiquity', discoverer:'N/A', composition:'Mostly hydrogen and helium', surface:'Cloud bands, storms, no solid surface', escapeVel:'59.5 km/s', albedo:'0.52', magneticField:'Strongest in solar system (20,000× Earth)', notable:'Great Red Spot is a storm wider than Earth. Gravity shields inner planets from comets.', missions:'Juno (2016-), Galileo (1995-2003), Voyager 1 & 2', fact:'Jupiter\'s Great Red Spot is a storm bigger than Earth that has raged for hundreds of years. It has 95 known moons!'} },
  { name:'Saturn',  color:'#f0d58c', orbit:210, size:13, speed:0.034, angle:2.5,
    type:'Gas Giant',
    info:{diameter:'120,536 km', distSun:'1.43B km', year:'29.46 years', day:'10.7 hours', moons:'146 known', type:'Gas Giant', gravity:'10.44 m/s²', temp:'-140°C (cloud tops)', atmosphere:'96% H₂, 3% He', rings:'Yes — prominent', volume:'764 Earths', mass:'95 Earths', density:'0.69 g/cm³', inclination:'2.49°', axialTilt:'26.7°', discovered:'Known since antiquity', discoverer:'N/A', composition:'Mostly hydrogen and helium', surface:'No solid surface, cloud layers', escapeVel:'35.5 km/s', albedo:'0.47', magneticField:'Yes', notable:'Least dense planet — would float in water. Titan has lakes of liquid methane.', missions:'Cassini-Huygens (2004-2017), Voyager 1 & 2', fact:'Saturn\'s rings span 280,000 km but are only ~10 m thick! Saturn is so light it would float in water.'} },
  { name:'Uranus',  color:'#7ec8e3', orbit:245, size:10, speed:0.012, angle:0.5,
    type:'Ice Giant',
    info:{diameter:'51,118 km', distSun:'2.87B km', year:'84 years', day:'17.2 hours', moons:'27', type:'Ice Giant', gravity:'8.87 m/s²', temp:'-195°C', atmosphere:'83% H₂, 15% He, 2% CH₄', rings:'Faint ring system', volume:'63 Earths', mass:'14.5 Earths', density:'1.27 g/cm³', inclination:'0.77°', axialTilt:'97.8°', discovered:'1781', discoverer:'William Herschel', composition:'Water, methane, ammonia ices', surface:'Featureless blue-green', escapeVel:'21.3 km/s', albedo:'0.3', magneticField:'Tilted 59°', notable:'First planet discovered with a telescope. Rotates on its side (98° tilt). Methane gives it the blue color.', missions:'Voyager 2 (1986 only)', fact:'Uranus rotates on its side with an axial tilt of 98° — it basically rolls around the Sun! It was the first planet discovered with a telescope.'} },
  { name:'Neptune', color:'#4a6db5', orbit:275, size:10, speed:0.006, angle:3.5,
    type:'Ice Giant',
    info:{diameter:'49,528 km', distSun:'4.50B km', year:'164.8 years', day:'16.1 hours', moons:'16', type:'Ice Giant', gravity:'11.15 m/s²', temp:'-200°C', atmosphere:'80% H₂, 19% He, 1% CH₄', rings:'Faint ring system', volume:'58 Earths', mass:'17 Earths', density:'1.64 g/cm³', inclination:'1.77°', axialTilt:'28.3°', discovered:'1846', discoverer:'Johann Galle (predicted by math)', composition:'Water, ammonia, methane ices', surface:'Deep blue from methane', escapeVel:'23.5 km/s', albedo:'0.41', magneticField:'Tilted 47°', notable:'Discovered using math before being observed! Winds reach 2,100 km/h — fastest in solar system.', missions:'Voyager 2 (1989 only)', fact:'Neptune has the strongest winds at 2,100 km/h — faster than any storm on Earth! It was discovered using math before being observed.'} }
];

var SOLAR_DWARFS = [
  { name:'Ceres', color:'#8a8a7a', orbit:138, size:3.5, speed:0.21, angle:2.0,
    info:{diameter:'940 km', distSun:'414M km', year:'4.6 years', day:'9.1 hours', moons:'0', type:'Dwarf Planet', gravity:'0.28 m/s²', temp:'-105°C', discovered:'1801', discoverer:'Giuseppe Piazzi', composition:'Rock and ice', surface:'Cratered, salt deposits', escapeVel:'0.51 km/s', albedo:'0.09', magneticField:'No', notable:'Bright spots in Occator crater are salt deposits from subsurface brine.', fact:'Ceres is the largest object in the asteroid belt and the only dwarf planet in the inner solar system. It may have a subsurface ocean!'} },
  { name:'Pluto', color:'#d4c5a9', orbit:295, size:3.5, speed:0.004, angle:4.0,
    info:{diameter:'2,377 km', distSun:'5.91B km', year:'248 years', day:'6.4 days', moons:'5', type:'Dwarf Planet', gravity:'0.62 m/s²', temp:'-230°C', discovered:'1930', discoverer:'Clyde Tombaugh', composition:'Rock and ice (N₂, CH₄, CO)', surface:'Mountains, glaciers, heart-shaped plain', escapeVel:'1.23 km/s', albedo:'0.49-0.66', magneticField:'Unknown', notable:'Has a thin atmosphere that freezes as snow when far from the Sun. Charon moon is so large it forms a binary system.', fact:'Pluto was reclassified as a dwarf planet in 2006. It has a heart-shaped glacier (Sputnik Planitia) and a thin nitrogen atmosphere.'} },
  { name:'Eris', color:'#e8d8c8', orbit:350, size:3, speed:0.002, angle:5.5,
    info:{diameter:'2,326 km', distSun:'10.12B km', year:'558 years', day:'25.9 hours', moons:'1', type:'Dwarf Planet', gravity:'0.82 m/s²', temp:'-231°C', discovered:'2005', discoverer:'Brown, Trujillo, Rabinowitz', composition:'Rock and ice (methane, nitrogen)', surface:'Icy, highly reflective', escapeVel:'1.38 km/s', albedo:'0.96', magneticField:'Unknown', notable:'Almost same size as Pluto but 27% more massive. Led to Pluto\'s reclassification.', fact:'Eris is almost the same size as Pluto but 27% more massive. Its discovery in 2005 sparked the debate that reclassified Pluto as a dwarf planet.'} },
  { name:'Makemake', color:'#b0a090', orbit:330, size:2.8, speed:0.003, angle:3.2,
    info:{diameter:'1,430 km', distSun:'6.85B km', year:'309 years', day:'22.5 hours', moons:'1', type:'Dwarf Planet', gravity:'0.5 m/s²', temp:'-239°C', discovered:'2005', discoverer:'Brown, Trujillo, Rabinowitz', composition:'Rock and methane ice', surface:'Reddish, methane-covered', escapeVel:'0.81 km/s', albedo:'0.77', magneticField:'Unknown', notable:'Named after Easter Island creator god. Extremely cold with reddish surface.', fact:'Makemake is named after the creator god of the Rapa Nui people of Easter Island. It is the second brightest Kuiper Belt object after Pluto.'} },
  { name:'Haumea', color:'#c0b8a0', orbit:320, size:2.5, speed:0.003, angle:6.0,
    info:{diameter:'1,632 km', distSun:'6.48B km', year:'283 years', day:'3.9 hours', moons:'2', type:'Dwarf Planet', gravity:'0.4 m/s²', temp:'-241°C', discovered:'2004', discoverer:'Brown et al.', composition:'Rock with water ice crust', surface:'Elongated, crystalline ice', escapeVel:'0.84 km/s', albedo:'0.66-0.80', magneticField:'Unknown', notable:'Only dwarf planet with rings. Spins every 3.9 hours, giving it a rugby-ball shape.', fact:'Haumea is shaped like a rugby ball due to its rapid rotation — it spins once every 3.9 hours! It also has a ring system, unique among dwarf planets.'} }
];

var SOLAR_FACTS = [
  "The Sun is 109 times wider than Earth!",
  "A year on Mercury is just 88 Earth days.",
  "Venus is the hottest planet at 465°C — even hotter than Mercury!",
  ...
  "Neptune was discovered using math before anyone saw it.",
  ...
  "One day on Venus lasts longer than one year on Venus.",
...
function initSolarSystem() {
  ...
  SOLAR.lastTime = performance.now();
  solarLoop(performance.now());
}

function solarLoop(time) {
  var dt = (time - SOLAR.lastTime) / 1000;
  SOLAR.lastTime = time;
  if (!SOLAR.paused) {
...
function solarDraw() {
  ...
  allBodies.forEach(function(p) {
    ...
    if (p.name === 'Saturn' && z > 0.15) {
      ...
      ctx.translate(x, y);
      ctx.scale(1, 0.3);
      ctx.strokeStyle = '#c8a050' + '80'; ctx.lineWidth = 3;
      ctx.beginPath(); ctx.arc(0, 0, p.size * 1.6, 0, Math.PI*2); ctx.stroke();
      ctx.strokeStyle = '#d4b060' + '50'; ctx.lineWidth = 1.5;
      ctx.beginPath(); ctx.arc(0, 0, p.size * 1.9, 0, Math.PI*2); ctx.stroke();
      ctx.strokeStyle = '#b89040' + '40'; ctx.lineWidth = 1;
      ctx.beginPath(); ctx.arc(0, 0, p.size * 2.2, 0, Math.PI*2); ctx.stroke();
      ctx.strokeStyle = '#c8a050' + '30'; ctx.lineWidth = 0.5;
      ctx.beginPath(); ctx.arc(0, 0, p.size * 2.5, Math.PI*0.1, Math.PI*1.9); ctx.stroke();
      ctx.restore();
    }
    ...
    if (p.name === 'Earth' && z > 0.4) {
      var moonAngle = p.angle * 13;
      var moonDist = p.size * 2.5;
      ctx.fillStyle = '#aaa';
      ctx.beginPath(); ctx.arc(x + Math.cos(moonAngle)*moonDist, y + Math.sin(moonAngle)*moonDist, p.size * 0.3, 0, Math.PI*2); ctx.fill();
    }
    ...
    if (p.name === 'Jupiter') {
      ctx.save();
      ctx.beginPath(); ctx.arc(x, y, ps, 0, Math.PI*2); ctx.clip();
      ctx.strokeStyle = 'rgba(180,120,80,0.2)'; ctx.lineWidth = 1.5;
      for (var b = -0.8; b <= 0.8; b += 0.35) {
        ctx.beginPath(); ctx.ellipse(x, y + b * ps * 0.5, ps * 0.7, ps * 0.12, 0, 0, Math.PI*2); ctx.stroke();
      }
      ctx.restore();
    }
    ...
    if (p.name === 'Earth' && z > 0.4) {
      ...
      ctx.fillRect(x - ps, y - ps*0.3, ps*2, ps*0.25);
      ctx.fillRect(x - ps*0.2, y - ps*0.5, ps*0.8, ps*0.4);
      ctx.fillRect(x + ps*0.3, y - ps*0.1, ps*0.5, ps*0.3);
      ctx.fillStyle = 'rgba(255,255,255,0.08)';
      ctx.beginPath(); ctx.arc(x - ps*0.2, y - ps*0.2, ps*0.3, 0, Math.PI*2); ctx.fill();
      ctx.restore();
    }
    ...
    if (p.name === 'Jupiter' || p.name === 'Saturn') {
      ...
      ctx.fillRect(x - ps * 0.8, y - ps * 0.15, ps * 1.6, ps * 0.3);
      ctx.restore();
    }
    ...
    if (z > 0.25) {
      ctx.shadowColor = 'rgba(0,0,0,0.8)'; ctx.shadowBlur = 4 / z;
      ctx.fillStyle = 'rgba(255,255,255,0.85)'; ctx.font = Math.max(8, Math.round(10 / z)) + 'px sans-serif';
      ctx.textAlign = 'center';
      ctx.fillText(p.name, x, y + ps + Math.max(10, 14 / z));
      ctx.shadowBlur = 0;
    }
  });
  ctx.restore();
...
function solarTogglePause() {
  SOLAR.paused = !SOLAR.paused;
  var btn = document.getElementById('solar-pause-btn');
